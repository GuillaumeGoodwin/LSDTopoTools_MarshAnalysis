...
sourcedir ="/home/s1563094/Datastore/Software/LSDTopoTools/LSDTopoTools_MarshAnalysis/Input/"
for site in Sites:
    ...
    sourcefile = sourcedir+"WOR_trans.asc" # This is the filename for your original DEM
    cutfile = sourcedir+"%s.shp" % (site) # This is the filename for your processed DEM
    destinationfile = sourcedir+"%s_DEM.bil" % (site) # This is the filename for your processed DEM
    os.system("gdalwarp -of ENVI -t_srs EPSG:27700 -cutline " + cutfile + " -crop_to_cutline " + sourcefile + " " +  destinationfile)"""
    ...
    TopoTools_dir = "/home/s1563094/Datastore/Software/LSDTopoTools/LSDTopoTools_AnalysisDriver/Analysis_driver/"

    driverfile = "%s.driver " % (site)
    #os.system("cd " + TopoTools_dir)
    os.system("./LSDTT_BasicMetrics.exe " + sourcedir + driverfile)
    #os.system("cd " + sourcedir)
    STOP
